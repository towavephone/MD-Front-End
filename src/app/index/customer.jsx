							...
							<div className="row">
								<div className="col-md-8 col-md-offset-2">
									...
									<div className="testimonial-body">
										...
										<div className="testimonial-info-2">By 广东美登纸业有限公司董事长</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="row">
								<div className="col-md-8 col-md-offset-2">
									...
									<div className="testimonial-body">
										...
										<div className="testimonial-info-2">By 广东美登纸业有限公司财务总监</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="row">
								<div className="col-md-8 col-md-offset-2">
									...
									<div className="testimonial-body">
										...
										<div className="testimonial-info-2">By 广东美登纸业有限公司总经理</div>
									</div>
								</div>
							</div>
						</div>
