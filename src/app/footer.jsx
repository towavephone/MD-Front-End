									...
									<div className="row">
										<div className="col-sm-6">
											...
											<ul className="social-links circle">
												<li className="facebook"><a target="_blank" href="javaScript:void(0)"><i className="fa fa-weixin"></i></a></li>
												<li className="twitter"><a target="_blank" href="javaScript:void(0)"><i className="fa fa-qq"></i></a></li>
												<li className="googleplus"><a target="_blank" href="javaScript:void(0)"><i className="fa fa-google-plus"></i></a></li>
												<li className="skype"><a target="_blank" href="javaScript:void(0)"><i className="fa fa-skype"></i></a></li>
												<li className="linkedin"><a target="_blank" href="javaScript:void(0)"><i className="fa fa-linkedin"></i></a></li>
											</ul>
										</div>
										<div className="col-sm-6">
